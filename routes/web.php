...
// Route::resource('users/create', UserController::class)->middleware(['auth', 'verified']);
// Route::resource('users/{user}/delete', UserController::class)->name('users.delete');
// Route::resource('users/{user}/delete', [UserController::class, 'delete'])->name('users.delete');
